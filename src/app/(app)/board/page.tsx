...
const SEED_OUTCOMES: OutcomeWithExtras[] = [
  ...
  { id: '5', title: 'Firebase push notifications', stage: 'BUILD', signalStatus: 'EMERGENCY', impactScore: 4, isAiPair: false, workspaceId: 'demo', createdById: 'demo', createdAt: '2025-01-22T00:00:00Z', updatedAt: '2025-02-08T00:00:00Z', stageChangedAt: '2025-02-08T00:00:00Z' },
...
function DetailPanel({ outcome, workspaceId, onClose, onAdvance, onRetreat, onUpdate, onDelete }: {
    ...
    <div style={{ position: 'fixed', top: 0, right: 0, bottom: 0, width: 400, background: '#061c2e', borderLeft: '1px solid rgba(45,212,191,0.2)', zIndex: 300, display: 'flex', flexDirection: 'column', boxShadow: '-8px 0 32px rgba(0,0,0,0.5)' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '20px 24px' }}>
        ...
        <CodeLinksSection
          ...
          onUpdate={links => onUpdate({ ...outcome, codeLinks: links })}
        />
